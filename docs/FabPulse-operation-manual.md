...
> 以「畫面」為單位之操作說明 · 版本 2026-06-12 · 對應分支 `master`
...
*本操作功能說明書依 2026-06-12 之 `master`（含導覽系統與 Handbook，v1.0.0.0）實機畫面與原始碼整理。技術架構細節另見 `docs/FabPulse-system-functional-spec.md`。*
